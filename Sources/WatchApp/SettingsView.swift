        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            case .sources:
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    Text("Videos shows YouTube videos and Instagram reels and posts you can open in the feed. Other contains the remaining bookmarks. Each tab sorts by the date you saved each link, newest first.")
